...
new_entries = df[df['Collectiondate'] >= previous_date]  # Assuming 'Date' is the column containing the date
...
if not new_entries.empty:
    ...
    text_file_path = r'C:\Users\beckett.mcfarland\Documents\txt_files\new_entries(parcel).txt'  # Replace with your desired text file path
