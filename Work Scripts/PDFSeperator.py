...
if __name__ == '__main__':
    input_pdf_path = r'L:\Rollout\Tablets\Scanned from a Xerox Multifunction Printer.pdf'  # Replace with the path to your input PDF file
    output_folder = r'L:\Rollout\Tablets\Scanned PDFs'  # Replace with the folder where you want to save the pages
