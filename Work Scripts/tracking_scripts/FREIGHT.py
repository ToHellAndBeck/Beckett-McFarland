...
if __name__ == "__main__":
    source_file_path = r"C:\Users\beckett.mcfarland\Documents\Copy of Freight shipping.xlsx"  # Provide the path to the source Excel file
    source_sheet_name = "2023"  # Specify the name of the source sheet
    
    destination_file_path = r"C:\Users\beckett.mcfarland\Documents\New Freight.xlsx"  # Provide the path to the destination Excel file
