...
new_entries = df[df['Collectiondate'] >= previous_date]  # Assuming 'Collectiondate' is the column containing the date
...
if not new_entries.empty:
    ...
    output_excel_file = os.path.join(output_dir, 'New_Parcel.xlsx')  # Updated file name to 'new_entries.xlsx'
