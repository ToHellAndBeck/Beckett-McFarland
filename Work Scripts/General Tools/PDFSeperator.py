...
if __name__ == '__main__':
    input_pdf_path = r'C:\Users\beckett.mcfarland\Desktop\Beckett-McFarland\Work Scripts\Tablet Checkout Sheet\PDFS\tablet_pdf.pdf'  # Replace with the path to your input PDF file
    output_folder = r'C:\Users\beckett.mcfarland\Desktop\Beckett-McFarland\Work Scripts\Tablet Checkout Sheet\PDFS\Seperated'  # Replace with the folder where you want to save the pages
