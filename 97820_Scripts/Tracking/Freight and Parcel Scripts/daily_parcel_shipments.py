...
source_workbook_path = "L:\\Public\\Lowell Warehouse Shipping\\Parcel Shipping.xlsm"
destination_workbook_path = r"C:\Users\beckett.mcfarland\Desktop\Beckett-McFarland\97820_Scripts\Tracking\Outputs\Parcel Shipments.xlsx"
...
source_sheet = source_workbook['2024 Parcel Shipping']
...
filter_column_index = 9  # Adjust as necessary, 9 for the 9th column
...
if matched_rows > 0:
    ...
    print("Filtered data has been successfully written and saved.")
    print("")
    print(f"{destination_workbook_path}")
else:
